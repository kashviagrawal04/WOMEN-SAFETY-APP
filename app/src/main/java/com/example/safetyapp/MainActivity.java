...
import com.example.safetyapp.utils.LocationSync;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startShakeServiceIfEnabled() {
        android.content.SharedPreferences prefs = getSharedPreferences(SettingsActivity.PREFS_NAME, MODE_PRIVATE);
        if (prefs.getBoolean(SettingsActivity.KEY_SHAKE_SOS, false)) {
            Intent shakeIntent = new Intent(this, com.example.safetyapp.service.ShakeDetectionService.class);
    ...
    private void fetchLocation() {
        ...
        LocationHelper.getLastLocation(this, new LocationHelper.LocationCallback() {
            ...
            public void onLocationReceived(double latitude, double longitude) {
                ...
                LocationSync.pushLocation(MainActivity.this, latitude, longitude);
