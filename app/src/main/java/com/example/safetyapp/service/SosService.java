...
public class SosService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            locationClient.getLastLocation().addOnSuccessListener(location -> {
                ...
                if (lat != 0 || lon != 0) {
                    com.example.safetyapp.utils.LocationSync.pushLocation(SosService.this, lat, lon);
                }
    ...
    private void sendSms(List<String> numbers, String message) {
        // Use context-aware SmsManager (API 31+) with fallback to getDefault()
    ...
    private void startAudioRecording() {
        try {
            ...
            // Use the constructor-based API for API 31+, setAudioSource API for older
